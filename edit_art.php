...
if (isset($_POST['edit'])) {
    ...
    if (empty($_FILES)) {
        ...
        $selectArt2 = mysqli_query($CONNECT,
            "UPDATE news SET caption = '$caption', article = '$article', src = '$dbpath2' WHERE id = '$id'");
        ...
        <div class="content">
            ...
            <form method="post" enctype="multipart/form-data" action="edit_art.php?id=<? echo $id; ?>">
                ...
                <textarea name="article" cols="80" rows="20"
                          placeholder="Статья"><? echo $result['article']; ?></textarea> <br>
